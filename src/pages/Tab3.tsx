...
<IonItem lines="none">
<p>DSD paperwork will be located at the front desk usually, however, you may need to contact grocery to get it.<br /> <br /> The top sheet goes into the pink bag, the rest goes into the purple bag.</p>
</IonItem>
</IonItemGroup>,
...
<IonItem lines="none">
<p>Grab a standard white envelope from the drawer, write todays date, the day, (friday for example) and your initials.</p>
</IonItem>
</IonItemGroup>,
...
4- On each bag, the reciever is USB, sender is your store number, also write the date, and your name.<br/>
...
<IonItem lines="none">
<p>Simply head outside and check if the SSCC light is flashing, if it is, get the key from the front desk, open up the SSCC, remove the full bag, seal it, replace it, and take the full bag to the office.</p>
</IonItem>
</IonItemGroup>,
...
<IonItemGroup>
<IonItemDivider>
  <IonTitle>WE, MO, and SSCC Reports</IonTitle>
</IonItemDivider>
<IonItem lines="none">
<p></p>
</IonItem>
...
<IonItemGroup>
<IonItemDivider>
  <IonTitle>Rinal Reports</IonTitle>
</IonItemDivider>
<IonItem lines="none">
<p></p>
</IonItem>
